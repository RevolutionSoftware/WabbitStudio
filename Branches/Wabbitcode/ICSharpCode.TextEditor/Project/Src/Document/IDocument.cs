...
//		}
        ...
        /// <remarks>
        /// Returns a valid offset for the given line number.
        /// </remarks>
        /// <param name="lineNumber">
        /// A line number which points to the line which first character offset number is returned.
        /// </param>
        /// <returns>
        /// An int which value is the first character offset in the line.
        /// </returns>
        /// <exception cref="System.ArgumentException">If offset points not to a valid position</exception>
