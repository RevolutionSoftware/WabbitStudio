...
namespace Revsoft.TextEditor.Document
{
	...
	public class DefaultTextEditorProperties : ITextEditorProperties
	{
        ...
        Color       iconBarBackColor = SystemColors.Control;
        Color       iconBarLineColor = SystemColors.ControlDark;
        bool        isSplit = false;
        ...
        public Color IconBarBackColor
        {
            get
            {
                return iconBarBackColor;
            }
            set
            {
                iconBarBackColor = value;
            }
        }
        public Color IconBarLineColor
        {
            get
            {
                return iconBarLineColor;
            }
            set
            {
                iconBarLineColor = value;
            }
        }
        public bool IsSplit
        {
