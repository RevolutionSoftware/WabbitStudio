...
namespace Revsoft.Wabbitcode
{
	public static class FileOperations
	{
		...
		/// </summary>
		public static string GetAbsolutePath(string baseDirectoryPath, string relativePath)
		{
			return NormalizePath(Path.Combine(baseDirectoryPath, relativePath));
		}
		...
		/// Slashes are replaced with backslashes, back references "." and ".." are 'evaluated'.
		/// </summary>
