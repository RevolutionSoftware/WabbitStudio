...
namespace Revsoft.Wabbitcode.AvalonEditExtension
{
	...
	/// </summary>
	public class WabbitcodeInsightWindow : OverloadInsightWindow, IInsightWindow
	{
		sealed class SDItemProvider : IOverloadProvider
		{
			readonly WabbitcodeInsightWindow insightWindow;
			int selectedIndex;
		...
		public WabbitcodeInsightWindow(TextArea textArea) : base(textArea)
		{
			...
			this.Style = Revsoft.Core.Presentation.GlobalStyles.WindowStyle;
			AttachEvents();
		}
