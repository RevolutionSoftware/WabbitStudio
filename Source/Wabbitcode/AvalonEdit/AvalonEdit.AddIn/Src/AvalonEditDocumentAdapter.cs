...
namespace Revsoft.Wabbitcode.AvalonEditExtension
{
    ...
    public class AvalonEditDocumentAdapter : IDocument
    {
        ...
        public static TextLocation ToLocation(TextLocation position)
        {
            return new TextLocation(position.Column, position.Line);
        }

        public static TextLocation ToPosition(TextLocation location)
        {
        ...
        sealed class AnchorAdapter : ITextAnchor
        {
            ...
            public Interface.AnchorMovementType MovementType
            {
                get
                {
                    return (Interface.AnchorMovementType)anchor.MovementType;
                }
                set
                {
